...
- 低オッズ（〜15倍）＋強いトレンド → 本命・対抗の最有力
- 低オッズ（〜15倍）＋弱いトレンド → 対抗・紐候補
- 中オッズ（15〜30倍）＋強いトレンド → 本命・対抗として十分あり
- 中オッズ（15〜30倍）＋弱いトレンド → 紐候補
- 高オッズ（30倍超）＋強いトレンド・複数アラート → 紐候補〜対抗。本命とする場合はその根拠を comment に明記
- 高オッズ（30倍超）＋弱いトレンド → 消し寄り
...
7. アラートの活用（重要）
   ...
   - 支持率急増アラートはその馬を紐候補以上に押し上げる強いシグナルと解釈する
